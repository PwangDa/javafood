...
public class GenreServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<!DOCTYPE html>"
				...
				+ "    <div class=\"title\">\r\n"
				+ "        <ul>\r\n"
				+ "            <li><strong>발라드</strong></li>\r\n"
				+ "            <li><strong>댄스</strong> </li>\r\n"
				+ "            <li><strong>POP</strong></li>\r\n"
				+ "            <li><strong>R&B</strong></li>\r\n"
				+ "            <li><strong>인디</strong></li>\r\n"
				+ "           <li><strong>트로트</strong></li>\r\n"
				+ "        </ul>\r\n"
				+ "    </div>\r\n"
				+ "    <br>\r\n"
				+ "    <br>\r\n"
		...
		for (int i = 0; i < vo.size(); i++) {
			out.println(  "        <tr>\r\n"
					...
					+ "            <td  class =\"td_no\" style=\"width: 30px\" ><strong>"+vo.get(i).getSongnumber()+"</strong></td>\r\n"
					+ "            <td style=\"width: 600px\"><strong>"+vo.get(i).getSongname()+"</strong></td>\r\n"
