...
public class GenreServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		dbon db = new dbon();
		List<vod> vo = db.list();
		List<vod> vobal = db.ballade();
		List<vod> vodan = db.dance();
		List<vod> vopop = db.pop();
		List<vod> vornb = db.rnb();
		List<vod> voindy = db.indy();
		List<vod> votrot = db.trot();
		...
		out.println("<!DOCTYPE html>"
				...
				+ "    <div class=\"title\">\r\n"
				+ "        <ul>\r\n"
				+ "            <li><a href='http://127.0.0.1:8080/javafood_team/genre?genre=ballad'><strong>발라드</strong></a></li>\r\n"
				+ "            <li><a href='http://127.0.0.1:8080/javafood_team/genre?genre=dance'><strong>댄스</strong></a></li>\r\n"
				+ "            <li><a href='http://127.0.0.1:8080/javafood_team/genre?genre=pop'><strong>POP</strong></a></li>\r\n"
				+ "            <li><a href='http://127.0.0.1:8080/javafood_team/genre?genre=rnb'><strong>R&B</strong></a></li>\r\n"
				+ "            <li><a href='http://127.0.0.1:8080/javafood_team/genre?genre=indy'><strong>인디</strong></a></li>\r\n"
				+ "            <li><a href='http://127.0.0.1:8080/javafood_team/genre?genre=trot'><strong>트로트</strong></a></li>\r\n"
				+ "        </ul>\r\n"
				+ "    </div>\r\n"
				+ "    <br>\r\n"
				+ "    <br>\r\n"
		...
		if("ballad".equals(song)) {
			for (int i = 0; i < vobal.size(); i++) {
				out.println(  "        <tr>\r\n"
						+ "            <td><input type=\"checkbox\" id=\"chk\"></td>\r\n"
						+ "            <td  class =\"td_no\" style=\"width: 30px\" ><strong>"+(i+1)+"</strong></td>\r\n"
						+ "            <td style=\"width: 600px\"><a href="+vobal.get(i).getLink()+"<strong>"+vobal.get(i).getSongname()+"</strong></a></td>\r\n"
						+ "            <td style=\"width: 200px\"><strong>"+vobal.get(i).getArtistname()+"</strong></td>\r\n"
...
+ "            <td class =\"td_img\" style=\"width: 40px\"><button type=\"button\" ><img  src=\"data:image/png;base64,\"></button></td>\r\n"
+ "            <td class =\"td_img\" style=\"width: 40px\"><button type=\"button\" ><img  src=\"https://cdn-icons-png.flaticon.com/512/7598/7598663.png\"></button></td>\r\n"
+ "        </tr>\r\n");
