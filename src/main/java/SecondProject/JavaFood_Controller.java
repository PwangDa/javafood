...
//		for(int i=0; i<album_addlist.size(); i++) {
//			if(album_addlist.get(i).getAlbum_name().equals(request.getParameter("name"))){
//				System.out.println(album_addlist.get(0).getName());
//			
//				String url = album_addlist.get(1).getName();
