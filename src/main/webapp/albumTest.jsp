...
<body>
   <jsp:include page="menu.jsp"></jsp:include>
    <div id = "home">
        <div class="cont1">
            <div class="cont1_1">
                <img class="img1" src="${album_info[0].album_cover }">
            </div>
            <div class="cont1_1">
                <h1>${album_info[0].album_name }</h1>
                <p><a href="/javafood_team/javafood?javafood=ArtistList&num=${album_info[0].album_add}">${album_info[0].artistname }</a></p>
                <p>아직내용 못가져옴</p>
                <details>
