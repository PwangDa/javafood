...
<body>
    ...
    <div id="home">
        <h1><a href='http://127.0.0.1:8080/javafood_team/Genre/gentesthtml.jsp'>장르</a></h1>
		...
		%>
        <div class="tab">
            <div class="tab1 tab1_1 btline"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=발라드'>발라드</a></div>
            <div class="tab1 tab1_2"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=댄스'>댄스</a></div>
            <div class="tab1 tab1_3"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=pop'>POP</a></div>
            <div class="tab1 tab1_4"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=R%26B'>R&B</a></div>
            <div class="tab1 tab1_5"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=인디'>인디</a></div>
            <div class="tab1 tab1_6"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=트로트'>트로트</a></div>
        </div>
        <%
		} else if ("댄스".equals(song)) {
		%>
		<div class="tab">
            <div class="tab1 tab1_1"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=발라드'>발라드</a></div>
            <div class="tab1 tab1_2 btline"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=댄스'>댄스</a></div>
            <div class="tab1 tab1_3"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=pop'>POP</a></div>
            <div class="tab1 tab1_4"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=R%26B'>R&B</a></div>
            <div class="tab1 tab1_5"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=인디'>인디</a></div>
            <div class="tab1 tab1_6"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=트로트'>트로트</a></div>
		...
		<div class="tab">
            <div class="tab1 tab1_1"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=발라드'>발라드</a></div>
            <div class="tab1 tab1_2"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=댄스'>댄스</a></div>
            <div class="tab1 tab1_3 btline"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=pop'>POP</a></div>
            <div class="tab1 tab1_4"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=R%26B'>R&B</a></div>
            <div class="tab1 tab1_5"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=인디'>인디</a></div>
            <div class="tab1 tab1_6"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=트로트'>트로트</a></div>
        </div>
		...
		<div class="tab">
            ...
            <div class="tab1 tab1_2"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=댄스'>댄스</a></div>
            <div class="tab1 tab1_3"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=pop'>POP</a></div>
            <div class="tab1 tab1_4 btline"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=R%26B'>R&B</a></div>
            <div class="tab1 tab1_5"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=인디'>인디</a></div>
            <div class="tab1 tab1_6"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=트로트'>트로트</a></div>
        </div>
        <%
		...
		<div class="tab">
            ...
            <div class="tab1 tab1_3"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=pop'>POP</a></div>
            <div class="tab1 tab1_4"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=R%26B'>R&B</a></div>
            <div class="tab1 tab1_5 btline"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=인디'>인디</a></div>
            <div class="tab1 tab1_6"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=트로트'>트로트</a></div>
        </div>
        <%
		...
		<div class="tab">
            ...
            <div class="tab1 tab1_4"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=R%26B'>R&B</a></div>
            <div class="tab1 tab1_5"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=인디'>인디</a></div>
            <div class="tab1 tab1_6 btline"><a href='http://localhost:8080/javafood_team/Genre/gentesthtml.jsp?genre=트로트'>트로트</a></div>
        </div>
        <%
		} else{
		%>
        ...
        <div class= "musiclist">
             <div class="cont2">
                ...
                <form method="post" action="/javafood_team/Genre/gentesthtml.jsp">
